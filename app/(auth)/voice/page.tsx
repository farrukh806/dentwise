...
const VoicePage = async () => {
  ...
  return (
    <div className="mt-5 flex gap-4">
      {/* How to use */}
      <Card className="flex-1 min-w-0 flex flex-col gap-2 outline outline-primary bg-linear-to-br from-primary/10 via-primary/5 to-background px-4">
      ...
      {/* Features */}
      <Card className="flex-1 min-w-0 flex flex-col gap-2 px-4">
        <div className="inline-flex gap-3 items-center">
          <div className="bg-primary/20 rounded-lg p-2">
